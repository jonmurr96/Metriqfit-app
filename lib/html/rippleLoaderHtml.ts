export const rippleLoaderHtml = `<!DOCTYPE html>
<html>
<head>
...
@keyframes ripple {
  0% {
    transform: scale(1);
    box-shadow: rgba(255, 255, 255, 0.08) 0px 10px 10px -0px;
  }
  50% {
    transform: scale(1.3);
    box-shadow: rgba(255, 255, 255, 0.08) 0px 30px 20px -0px;
  }
  100% {
    transform: scale(1);
    box-shadow: rgba(255, 255, 255, 0.08) 0px 10px 10px -0px;
...
.box:nth-child(3) { animation-delay: 1.0s; }
.box:nth-child(4) { animation-delay: 1.5s; }
.box:nth-child(5) { animation-delay: 2.0s; }
...
.svg {
  ...
  height: 60px;
  display: block;
  animation: color-change 3.5s infinite ease-in-out;
}
</style>
</head>
<body>
