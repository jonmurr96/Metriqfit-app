    ...
    workoutDays: [
      {
        ...
        exercises: [
          ...
          makeExercise({ id: 'dip', name: 'Chest Dips', pattern: 'horizontal_push', primary_muscle: 'chest', primary_muscles: ['chest'], split_tags: ['push'] }),
          makeExercise({ id: 'face-pull', name: 'Face Pull', pattern: 'rear_delt', primary_muscle: 'rear_delts', primary_muscles: ['rear_delts'], split_tags: ['pull'], is_compound: false }),
        ],
      },
      {
        dayName: 'Pull',
        ...
        exercises: [
          makeExercise({ id: 'row', name: 'Chest Supported Row', pattern: 'horizontal_pull', primary_muscle: 'back', primary_muscles: ['back'], split_tags: ['pull'] }),
          makeExercise({ id: 'pulldown', name: 'Lat Pulldown', pattern: 'vertical_pull', primary_muscle: 'back', primary_muscles: ['back'], split_tags: ['pull'] }),
          makeExercise({ id: 'db-press', name: 'Dumbbell Shoulder Press', pattern: 'vertical_push', primary_muscle: 'shoulders', primary_muscles: ['shoulders'], split_tags: ['push'] }),
          ...
          makeExercise({ id: 'curl', name: 'Hammer Curl', pattern: 'bicep_curl', primary_muscle: 'biceps', primary_muscles: ['biceps'], split_tags: ['pull'], is_compound: false }),
        ],
      },
    ],
  });
    ...
    workoutDays: [
      {
        ...
        exercises: [
          ...
          makeExercise({ id: 'curl-machine', name: 'Preacher Curl Machine', pattern: 'bicep_curl', primary_muscle: 'biceps', primary_muscles: ['biceps'], split_tags: ['arms'], is_compound: false }),
        ],
      },
    ],
  });
